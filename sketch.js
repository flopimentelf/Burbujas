...
function setup() {
  ...
  bgColor = color(255); // Color de fondo blanco
  textFont("Arial", 24); // Establece la fuente y el tamaño del título
  textAlign(CENTER, CENTER); // Centra el texto en el lienzo
  fill(0); // Color del texto en negro
  text("REVIENTALAS", width / 2, 30); // Título
}

function draw() {
  background(bgColor); // Fondo blanco
